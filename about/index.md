...
In May 2018, I graduated from the University of Wisconsin-Madison with a BS in Computer Science and a certificate in Mathematics. Over the past decade, I have been working with my current employer, Liberty Mutual, advancing through the following positions: Technology Associate, Associate Software Engineer, Software Engineer, Senior Software Engineer, Principal Software Engineer, Solutions Engineer (Software Architect) (Stretch Assignment) (Current Title).
